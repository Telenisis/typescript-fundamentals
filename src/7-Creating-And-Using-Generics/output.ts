...
function whatIst_number(arg: number) :number{
  return arg;
}
console.log(`${prefix} Generics Overview`);
console.log(whatIst_number(11));


function whatIst_string(arg: string) :string{
  return arg;
}
console.log(whatIst_string('billy'));

function whatIst_any(arg: any) :any {
  return arg;
}
console.log(whatIst_any('billy'));
console.log(whatIst_any(33));
...
let s: string = whatIsIt_typed<string>('peeps');
let b: boolean = whatIsIt_typed<boolean>(false);
...
console.log(`${prefix} generic models`)
